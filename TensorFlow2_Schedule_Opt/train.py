...
from TensorFlow2_Schedule_Opt.model import AttentionModel
from TensorFlow2_Schedule_Opt.baseline import RolloutBaseline
from TensorFlow2_Schedule_Opt.data import generate_data
from TensorFlow2_Schedule_Opt.config import Config, load_pkl, file_parser
...
def train(cfg, log_path = None):
	...
	for epoch in range(cfg.epochs):
		...
		dataset = generate_data(cfg.n_samples, cfg.n_customer)#128000,20
		...
		for t, inputs in enumerate(dataset.batch(cfg.batch)):#512
